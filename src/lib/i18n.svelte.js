...
const T = {
  es: {
    ...
    min: 'min',
    greet_t: '¡Bienvenido a Proenza!',
    greet_role: 'Recepcionista virtual',
    greet_b: 'Recorre el despacho con W/S y A/D; arrastra para mirar. Cuando quieras, deja tu caso en recepción o agenda con un abogado.',
    greet_close: 'Comenzar',
    recep_hi: 'Te saluda',
    blog_search: 'Buscar artículo…',
    blog_all: 'Todas',
    blog_empty: 'Sin resultados. Prueba otra búsqueda.',
  ...
  en: {
    ...
    blog_back: '← Library',
    min: 'min',
    greet_t: 'Welcome to Proenza!',
    greet_role: 'Virtual receptionist',
    greet_b: 'Move around with W/S and A/D; drag to look. Whenever you like, leave your case at reception or book with a lawyer.',
    greet_close: 'Get started',
    recep_hi: 'A note from',
    blog_search: 'Search articles…',
    blog_all: 'All',
    blog_empty: 'No results. Try another search.',
